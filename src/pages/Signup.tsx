      ...
      <div className="w-full max-w-md space-y-8">
        <div className="text-center">
          <Link to="/" className="inline-flex items-center gap-2 mb-8">
            ...
            <span className="font-bold text-2xl">SecondBrain AI</span>
          </Link>
          <h1 className="text-3xl font-bold mb-2">Create your account</h1>
          <p className="text-muted-foreground">Get started with your Second Brain</p>
        </div>
        ...
        <Card className="border-border/50 glass-card">
          ...
          <CardContent>
            <Alert className="mb-4 bg-primary/10 text-primary border-primary/20">
              ...
              <AlertDescription>
                For quickest testing, you may want to disable email verification in the Supabase dashboard.
              </AlertDescription>
            </Alert>
